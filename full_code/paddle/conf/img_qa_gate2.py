...
MixedLayer(name = 'language',
    ...
    inputs = [FullMatrixProjection('question_expand', parameter_name = '_language.w0'),
        FullMatrixProjection('word_embedding', parameter_name = '_language.w1'),
...
MixedLayer(name = 'hidden2',
    size = multimodal_dim,
    active_type = 'stanh',
    inputs = [IdentityProjection('gated_language'),
