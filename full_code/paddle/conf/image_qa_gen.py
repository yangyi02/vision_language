...
image_feat_memory = Memory(name = 'image_feat_memory',
    size = image_feat_dim,
    boot_layer = 'image_feat',
    is_sequence = False,
)

MixedLayer(name = 'image_feat_memory',
    size = image_feat_dim,
    bias = False,
...
MixedLayer(name = 'hidden2',
    ...
    inputs = [FullMatrixProjection(question_memory, parameter_name = '_hidden2.w0'),
        FullMatrixProjection('predict_word_embedding', parameter_name = '_hidden2.w1'),
        FullMatrixProjection(image_feat_memory, parameter_name = '_hidden2.w2'),
...
#        'hidden2',
#        initial_std = math.sqrt(1. / multimodal_dim)),
#)
