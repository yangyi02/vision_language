    ...
    def prepare_text(self):
        ...
        for i in xrange(len(train_ids)):
            if random.random() < 0.5:
                sample = {'image_id': train_ids[i], 'caption': 'an object in the image'}
            else:
                sample = {'image_id': train_ids[i], 'caption': 'an object in image'}
        ...
        for i in xrange(len(test_ids)):
            if random.random() < 0.5:
                sample = {'image_id': test_ids[i], 'caption': 'an object in the image'}
            else:
                sample = {'image_id': test_ids[i], 'caption': 'an object in image'}
